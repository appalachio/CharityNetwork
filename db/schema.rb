...
ActiveRecord::Schema[8.0].define(version: 2025_08_11_225906) do
  ...
  create_table "donations", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["claimed_by_id"], name: "index_donations_on_claimed_by_id"
  ...
  add_foreign_key "donations", "charities", column: "claimed_by_id"
